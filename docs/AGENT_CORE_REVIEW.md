...
- [x] Вынесены provider adapters из `agent.py` в `core/providers/` (`gemini.py`, `openai_reasoning.py`, `factory.py`, `base.py`). Добавлены 36 provider regression tests. `agent.py` сокращён с 989 до ~230 строк. Полный набор: `652 passed`.
